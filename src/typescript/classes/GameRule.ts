import {
    ...
    getCurrentGameSize,
    getCurrentGameTime,
    getCurrentGameTopic, getLocalGuestId,
    getUserId, setLocalGuestId
...
export class NormalGameRule extends GameRule {
    ...
    showResultBoard = (gameScore: number, totalCoins?: number, scoreCoin?: number, gameSizeBonus?: number, gameTimeBonus?: number, isHaveHighestScore = false) => {
