...
import { getCurrentCardTheme, getCurrentGameTopic, getListVipGames, setCardTheme, setGameTopic } from "../ts-utils/General.js";
...
const handleShowOwnedGameTopics = (searchString: string | null = null) => {
